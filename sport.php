...
<header class="header">
    ...
    <div class="container">
        ...
        <div class="container__nav">
          <nav class="nav">
            ...
            <a class="nav__link" href="science.php">Наука</a>
    ...
    <div class="content">
        <?
          $result = $mysqli->query('SELECT * FROM `news` where `category`="Спорт"');
          while($row = mysqli_fetch_assoc($result)): // запрос на выборку?>
